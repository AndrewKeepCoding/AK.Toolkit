...
public sealed partial class GridViewsPage : Page
{
    public GridViewsPage()
    {
        InitializeComponent();
        Loaded += GridViews_Loaded;
    }
    ...
    private void GridViews_Loaded(object sender, RoutedEventArgs e)
    {
