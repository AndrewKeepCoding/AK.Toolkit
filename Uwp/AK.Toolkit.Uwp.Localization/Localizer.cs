...
namespace AK.Toolkit.Uwp.Localization
{
    ...
    {
        private readonly HashSet<UIElement> rootElements = new HashSet<UIElement>();
        ...
        private LanguageDictionaries LanguageDictionaries { get; set; } = new LanguageDictionaries();
