...
namespace AK.Toolkit.Uwp.Localization
{
    ...
    {
        private readonly UIElementChildrenGetters childrenGetters = new UIElementChildrenGetters();
        ...
        {
            private Dictionary<Type, Func<UIElement, IEnumerable<UIElement>>> dictionary = new Dictionary<Type, Func<UIElement, IEnumerable<UIElement>>>();
